	...
	<div class="container">
		...
		<form class="form-horizontal" action="Driver_Details.php" method="post">
			...
			<div class="form-group">
				<label class="control-label col-sm-3" for="License_Number">Driver License Number : </label>
				<div class="col-sm-15">
			...
			<div class="form-group">
				<label class="control-label col-sm-3" for="Fname">Driver's First Name : </label>
				<div class="col-sm-15">
			...
			<div class="form-group">
				<label class="control-label col-sm-3" for="Lname">Driver's Last Name : </label>
				<div class="col-sm-15">
			...
			<div class="form-group">
				<label class="control-label col-sm-3" for="Birthdate">Driver's Birth Date : </label>
				<div class="col-sm-15">
