	...
	<div class="container">
		...
		<form class="form-horizontal" action="Home_Details.php" method="post">
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="Purchased_Date">Home Purchased Date:</label>
					<input type="date" name="Purchased_Date" required placeholder="mm/dd/yy">
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="Purchased_Value">Home Purchased Value:</label>
				<input type="float" name="Purchased_Value" required placeholder="Purchased Value..">
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="Home_Area">Home Area:</label>
				<input type="Number" name="Home_Area" required placeholder="Home Area..">
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="Home_Type">Home Type:</label>
				<input class="radiobtn" type="radio" id="s" name="ht" value="s" checked>
 				...
 				<input class="radiobtn" type="radio" id="m" name="ht" value="m">
  					<label for="m">Multi Family</label>
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="AutoFire">AutoFire Notification:</label>

				<input class="radiobtn" type="radio" id="yes" name="af" value=1 checked>
				<label for="yes"> I want auto fire notification to the fire department</label><br>
				<input class="radiobtn" type="radio" id="no" name="af" value=0>
				<label for="no"> I don't want fire department to be notified</label>
				
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="homesec">Home Security System:</label>

				<input class="radiobtn" type="radio" id="yes" name="hs" value=1 checked>
				<label for="yes">Home security system is installed and monitored</label><br>
				<input class="radiobtn" type="radio" id="no" name="hs" value=0>
				<label for="no"> Home security system is not installed or monitored</label>
				
			</div>

			
			<div class="form-group">
				<label class="control-label col-sm-2" for="swimmingpool">swimmingpool:</label>
				...
				<label for="o">Overground swimming pool</label>
				...
				<label for="m">Multiple swimming pool</label>
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="basement">Basement:</label>

				<input class="radiobtn" type="radio" id="yes" name="b" value=1 checked>
				<label for="yes">I want a basement</label><br>
