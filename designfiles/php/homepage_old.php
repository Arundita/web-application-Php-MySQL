...
<br>
			...
			<div class="form-group">
				...
				<input class="radiobtn" type="radio" id="s" name="ms" value="s">
 				...
 				<input class="radiobtn" type="radio" id="w" name="ms" value="w">
  					<label for="female">Widow/Widower</label>
				
			</div>

			<div class="form-group">
				<label class="control-label col-sm-2" for="ct">Customer Type:</label>
				<input class="radiobtn" type="radio" id="a" name="ct" value="a" checked>
  					<label for="male">Automobile Insurance customer</label>
 				<input class="radiobtn" type="radio" id="h" name="ct" value="h">
  					<label for="female">Home Insurance Customer</label>
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="eu">Are you an employee of WDS? :</label>
				<input class="radiobtn" type="radio" id="a" name="eu" value="y" >
  					<label for="y">Yes I am a WDS csutomer</label>
 				<input class="radiobtn" type="radio" id="h" name="eu" value="n" checked>
  					<label for="n">No I am not a WDS customer</label>
